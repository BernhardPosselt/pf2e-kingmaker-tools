...
fun PF2EHazard.update(data: PF2EHazard, operation: DatabaseUpdateOperation = jso()): Promise<PF2EHazard?> =
...
fun <O> Hooks.onRenderPF2EHazardSheet(callback: RenderApplication<PF2EHazardSheetData, O>) =
